...
| Name | Type |
|------|------|
| [nexus_repository_npm_proxy.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_npm_proxy) | resource |
...
| <a name="input_remove_non_cataloged"></a> [remove\_non\_cataloged](#input\_remove\_non\_cataloged) | Remove non-catalogued versions from the npm package metadata. | `bool` | `null` | no |
| <a name="input_remove_quarantined"></a> [remove\_quarantined](#input\_remove\_quarantined) | Remove quarantined versions from the npm package metadata. | `bool` | `null` | no |
