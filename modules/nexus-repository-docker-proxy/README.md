...
| Name | Type |
|------|------|
| [nexus_repository_docker_proxy.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_docker_proxy) | resource |
...
| <a name="input_docker_proxy"></a> [docker\_proxy](#input\_docker\_proxy) | docker contains the configuration of the docker repository | <pre>object({<br>    index_type = string<br>    index_url  = optional(string)<br>  })</pre> | n/a | yes |
