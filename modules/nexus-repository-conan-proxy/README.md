...
| Name | Type |
|------|------|
| [nexus_repository_conan_proxy.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_conan_proxy) | resource |
...
| <a name="input_online"></a> [online](#input\_online) | Whether this repository accepts incoming requests | `bool` | `true` | no |
