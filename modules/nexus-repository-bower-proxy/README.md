...
| Name | Type |
|------|------|
| [nexus_repository_bower_proxy.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_bower_proxy) | resource |
...
| <a name="input_rewrite_package_urls"></a> [rewrite\_package\_urls](#input\_rewrite\_package\_urls) | The name of the routing rule assigned to this repository | `bool` | n/a | yes |
