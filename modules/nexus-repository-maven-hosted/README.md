...
| Name | Type |
|------|------|
| [nexus_repository_maven_hosted.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_maven_hosted) | resource |
...
| <a name="input_maven"></a> [maven](#input\_maven) | The storage configuration of the repository | <pre>object({<br>    version_policy      = string<br>    layout_policy       = string<br>    content_disposition = optional(string)<br>  })</pre> | n/a | yes |
