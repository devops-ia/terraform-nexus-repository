...
| Name | Type |
|------|------|
| [nexus_repository_apt_hosted.main](https://registry.terraform.io/providers/datadrivers/nexus/latest/docs/resources/repository_apt_hosted) | resource |
...
| <a name="input_signing"></a> [signing](#input\_signing) | Signing contains signing data of hosted repositores of format Apt | <pre>object({<br>    keypair    = string<br>    passphrase = optional(string)<br>  })</pre> | n/a | yes |
